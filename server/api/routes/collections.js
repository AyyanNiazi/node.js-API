...
// get Collection Token by id
router.get('/:address/tokens', collection_controller.getCollectionToken)
// get Collection Token by id
router.get('/:address/tokens/:tokenId', collection_controller.getCollectionTokenById)
